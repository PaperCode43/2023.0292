...
function []=KrigEuro_cokriging_deri(S0,r,sigma,T,K,n,alpha,M,t,poly_d,Tru_MC_idx)
...
n=length(X);
if Tru_MC_idx==1
    [Y,dY]=bls_Euro_call(X,K,r,sigma,t,T);
    vY=0.0*ones(n,1);
    vdY=0.000*ones(n,1);
...
[Y_true,dY_true]=bls_Euro_call(Xtest,K,r,sigma,t,T);
