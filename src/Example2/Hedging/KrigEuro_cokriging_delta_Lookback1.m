...
function [V,VdS0]=KrigEuro_cokriging_delta_Lookback1(X,K,T,iday,n,r_n,sigma_vg,nu_vg,theta_vg,M,poly_d,Xtest)
...
[Y,vY,dY,vdY,vYdY] = VG_call_Lookback_v_hedge(X(:,1),K,T,iday,n,M,r_n,sigma_vg,nu_vg,theta_vg);
