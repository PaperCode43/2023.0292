...
function [V,VdS0,Vdsigma,Vdtheta]=KrigEuro_cokriging_Asian_p(X,K,T,n,r_n,nu_vg,M,poly_d,Xtest)
...
[Y,vY,dS0,vdS0,dsigma,vdsigma,dtheta,vdtheta,vMatrix] = VG_call_Asian_v(X(:,1),K,T,n,M,r_n,X(:,2),nu_vg,X(:,3));
