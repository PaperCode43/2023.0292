figure(1)
hold on
boxplot(sqrt([RMSE_V_SK',RMSE_V_ESK']),'Labels',{'SK','ESK'})
...
figure(2)
hold on
boxplot([RMSE_delta_SK',RMSE_delta_ESK'],'Labels',{'SK','ESK-D'})
...
figure(3)
hold on
boxplot([RMSE_vega_SK',RMSE_vega_ESK'],'Labels',{'SK','ESK-D'})
%plot([0.5+1/4+0.035,1.5-1/4-0.035],PCCnoadd*ones(1,2),'c-',[1.5+0.035+1/4,2.5-1/4-0.035],PCCaddec*ones(1,2),'c-',...
 %   [2.5+0.035+1/4,3.5-1/4-0.035],PCCadddc*ones(1,2),'c-')
...
figure(4)
hold on
boxplot([RMSE_rho_SK',RMSE_rho_ESK'],'Labels',{'SK','ESK-D'})
%plot([0.5+1/4+0.035,1.5-1/4-0.035],PCCnoadd*ones(1,2),'c-',[1.5+0.035+1/4,2.5-1/4-0.035],PCCaddec*ones(1,2),'c-',...
 %   [2.5+0.035+1/4,3.5-1/4-0.035],PCCadddc*ones(1,2),'c-')
ylabel('RMSE for Rho')
set(gca,'FontSize',16);
...
figure(5)
hold on
boxplot([RMSE_theta_SK',RMSE_theta_ESK'],'Labels',{'SK','ESK-D'})
%plot([0.5+1/4+0.035,1.5-1/4-0.035],PCCnoadd*ones(1,2),'c-',[1.5+0.035+1/4,2.5-1/4-0.035],PCCaddec*ones(1,2),'c-',...
 %   [2.5+0.035+1/4,3.5-1/4-0.035],PCCadddc*ones(1,2),'c-')
